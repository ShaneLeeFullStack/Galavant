...
function tripsit_dropdown() {
  document.getElementById("tripsit_dropdown").classList.toggle("show");
}

function journey_dropdown() {
  document.getElementById("journey_dropdown").classList.toggle("show");
}
